...
Please refer to [Pakbin et al. (2023)](#suggested-citations) for details, which significantly extends BoXHED1.0 ([Wang et al. 2020](#suggested-citations)). The theoretical underpinnings for BoXHED is provided in [Lee, Chen, Ishwaran (2021)](#suggested-citations).
